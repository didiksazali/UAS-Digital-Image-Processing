...
begin
  Application.CreateForm(TF_Citra2, F_Blending);
  F_Blending.Image1.Picture:=F_Citra2.Image1.Picture;
...
begin
  ...
  if (F_Citra2.Image1.Picture.Height > F_Rotate.Image1.Picture.Height) then
    batas_baris:=F_Rotate.Image1.Picture.Height
  else
    batas_baris:=F_Citra2.Image1.Picture.Bitmap.Height;

  for i := 0 to batas_baris - 1 do
    begin
      PC:=F_Rotate.Image1.Picture.Bitmap.ScanLine[i];
      PC2:=F_Citra2.Image1.Picture.Bitmap.ScanLine[i];
      PH:=F_Blending.Image1.Picture.Bitmap.ScanLine[i];

        if (F_Citra2.Image1.Picture.Width > F_Rotate.Image1.Picture.Width) then
          batas_kolom:=F_Rotate.Image1.Picture.Width
        else
